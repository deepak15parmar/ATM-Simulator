...
public class Signup2 extends JFrame implements ActionListener{
	...
	Signup2(long form){
		...
		String income[] = {"less than 1,00,000","<1,50,000","<2,50,000","<5,00,000","Upto 10,00,000","Above 10,00,000"};
	...
	public void actionPerformed(ActionEvent ae){
		...
		try{
			...
			}else if(!Pattern.matches("^[A-Z]{5}\\d{4}[A-Z]$", f)) {
				JOptionPane.showMessageDialog(null, "Invalid PAN number.");
				t1.setText("");
			}else if(!Pattern.matches("^\\d{12}$", g)) {
				JOptionPane.showMessageDialog(null, "Invalid Aadhar number.");
				t2.setText("");
			}else if(!(r1.isSelected()^r2.isSelected())  ||  !(r3.isSelected()^r4.isSelected())) {
				JOptionPane.showMessageDialog(null, "Select options - Yes or No");
			}else{
				conn c1 = new conn();
				String q1 = "insert into signup2 values('"+formNo+"','"+a+"','"+b+"','"+c+"','"+d+"','"+e+"','"+f+"','"+g+"','"+h+"','"+i+"')";
...
//		new Signup2(123).setVisible(true);
//	}
}
