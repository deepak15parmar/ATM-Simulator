        ...
        try{        
            ...
            if(ae.getSource()==b1){
                ...
                if(t2.getText().equals(t3.getText())){
                    ...
                    conn c1 = new conn();
                    String q1 = "update bank set pin = '"+b+"' where pin = '"+a+"' AND accno = '"+cardno+"' ";
                    String q3 = "update signup3 set pin = '"+b+"' where pin = '"+a+"' AND cardno = '"+cardno+"' ";
...
//        new Pin("5040935989343905").setVisible(true);
//    }
